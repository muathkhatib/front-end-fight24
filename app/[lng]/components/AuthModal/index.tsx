...
export default function AuthModal({ showAuthModal, setShowAuthModal }: any) {
  ...
  return (
    <>
      {isModalVisible && (
        <div
          className="fixed inset-0 flex items-center justify-center bg-base-black bg-opacity-75 z-50 overflow-y-auto"
          onClick={handleClose}
        >
          <div
            className="max-w-lg mx-auto p-4 bg-base-black rounded-lg"
